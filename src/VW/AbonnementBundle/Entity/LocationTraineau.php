 ...
 * @ORM\Table(name="prix_location_traineau")

 * @ORM\Entity(repositoryClass="VW\AbonnementBundle\Repository\LocationTraineauRepository")

 */

class LocationTraineau

{
    ...
    public function __toString(){
        ...
        return $this->sport->getNom() . " (" . $this->duree->getNom() . ")";
