...

{
...

    {
        ...
        if ($request->isMethod('POST') && $form->handleRequest($request)->isValid()) {
            ...
            //taxe
            $prix_total = number_format($prix_total + ($prix_total*0.05) + ($prix_total*0.09975), 2);
    ...
    public function factureAction($token)

    {
        ...
        return $this->render('VWAbonnementBundle:Abonnement:facture.html.twig', array(
